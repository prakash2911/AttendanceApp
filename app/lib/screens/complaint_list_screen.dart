...
class _ComplaintListState extends State<ComplaintList> {
  ...
  List<Person> persons = [
    Person(name: 'Bill Will', bio: "Start by taking a couple of minutes to read the info in this section. Launch your app and click on the Settings menu.  While on the settings page, click the Save button.  You should see a circular progress indicator display in the middle of the page and the user interface elements cannot be clicked due to the modal barrier that is constructed."),
        ...
        child: GestureDetector(
          onTap: () {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        DetailPage(topic: topic, description: description, complaint: Person,)));
          },
          child: Card(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            DetailPage(topic: topic, description: description, complaint: complaints[index],)));
              },
              child: Card(
                color: Colors.grey[800],
                child: Padding(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(complaints[index].block,
                              style: const TextStyle (
                                  color: Colors.white,
                                  fontSize: 18
                              ),
                            ),
                            Text(complaints[index].complaint,
                              style: const TextStyle (
                                  color: Colors.white,
                                  fontSize: 12,
                                  overflow: TextOverflow.ellipsis
